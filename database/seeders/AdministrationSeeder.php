...
class AdministrationSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        //MAINTENANCES MODEL
        $maintenances1 = Permission::create(['name' => 'create maintenances']);
        $maintenances2 = Permission::create(['name' => 'read maintenances']);
        $maintenances3 = Permission::create(['name' => 'update maintenances']);
        $maintenances4 = Permission::create(['name' => 'delete maintenances']);
